...
},{"./viewModels/planner":14,"backbone":"p0Xhkj","jquery":"gpwEjE","react":"S6YYKo","underscore":"aaqpWy"}],2:[function(require,module,exports){
/**
* @jsx React.DOM
*/
var HourControl = React.createClass({displayName: 'HourControl',
  onChange: function (e) {
  ...
  render: function () {
    return (
      React.DOM.input( {type:"range", min:"0", max:"60", step:"10", value:this.props.day.get('hoursAlloc'), onChange:this.onChange})
    );
  }

});

var HourOutput = React.createClass({displayName: 'HourOutput',
  ...
  render: function () {
    ...
    return (React.DOM.span( {className:"hour-output"}, 
...
var DayComponent = React.createClass({displayName: 'DayComponent',
  ...
  render: function () {
    ...
    return (
      React.DOM.div( {key:day.get('name'), className:'day ' + day.get('name')} , 
        React.DOM.div( {className:"data-wrapper"}, 
          HourOutput( {day:day} ),
          HourControl( {day:day} )
        ),
        React.DOM.h3(null, day.get('name').toUpperCase())
      )
    );
  }
});
...
var totalOutput = React.createClass({displayName: 'totalOutput',
  getInitialState: function () {
    var updateState = function () {
  ...
  render: function () {
    ...
    return (
      React.DOM.div( {className:"total-display"}, 
        React.DOM.span( {className:"total"}, days.totalWorkout()),
        React.DOM.span( {className:"label"},  " min")
      )
    );
  }
});
...
var DayComponent = React.createClass({displayName: 'DayComponent',
  ...
  render: function () {
    ...
    return (
      React.DOM.header( {className:"fitness-header"} , 
        React.DOM.h1(null, "Weekly Fitness Goal: ",  days.fitnessGoal,  " Min"),
...
var WeekComponent = React.createClass({displayName: 'WeekComponent',
  ...
  render: function () {
    ...
    return (
      React.DOM.div( {className:"wrapper weekly-fitness-planner"}, 
        headerComponent( {days:this.props.days} ),
        React.DOM.div( {className:"week-controls"}, week)
      )
    );
  }
});
...
},{"./dayComponent.jsx":2,"./headerComponent.jsx":3}],5:[function(require,module,exports){
// Day Model
...
module.exports=require('p0Xhkj');
},{}],"p0Xhkj":[function(require,module,exports){
(function (global){
...
},{"underscore":"aaqpWy"}],"gpwEjE":[function(require,module,exports){
(function (global){
(function browserifyShim(module, exports, define, browserify_shim__define__module__export__) {
/*!
...
module.exports=require('gpwEjE');
},{}],"S6YYKo":[function(require,module,exports){
(function (global){
(function browserifyShim(module, exports, define, browserify_shim__define__module__export__) {
/**
 * React v0.10.0
...
module.exports=require('S6YYKo');
},{}],"underscore":[function(require,module,exports){
module.exports=require('aaqpWy');
},{}],"aaqpWy":[function(require,module,exports){
(function (global){
(function browserifyShim(module, exports, define, browserify_shim__define__module__export__) {
//     Underscore.js 1.6.0
...
},{"../components/dayComponent.jsx":2,"../components/weekComponent.jsx":4,"../models/day":5}]},{},[1])